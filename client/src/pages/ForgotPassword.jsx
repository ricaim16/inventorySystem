  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row w-full max-w-4xl h-[500px] max-h-[90vh] rounded-xl overflow-hidden shadow-lg">
        ...
        >
          <h2 className="text-3xl font-bold font-['Arial']">RESET PASSWORD</h2>
        </div>
        ...
        >
          <div className="w-full max-w-md z-10">
            <p className="text-center mb-6 font-['Arial'] text-xl font-bold text-[#5DB5B5]"></p>

            {error && (
              <div
                className={`w-full ${
                  theme === "dark"
                    ? "bg-gray-700 text-[#5DB5BULB5]"
