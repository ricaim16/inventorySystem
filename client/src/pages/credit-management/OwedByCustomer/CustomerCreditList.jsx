    ...
    >
      <div className="flex justify-between items-center mb-4 sm:mb-6">
        ...
        <Link
          ...
          className={`bg-[#10B981] text-white px-3 py-1.5 rounded hover:bg-[#0ea271] transition duration-300 text-xs sm:text-sm md:text-base`}
        >
                    ...
                    <tr
                      ...
                      className={`border-b ${
                        ...
                        isOverdueByTwoMonths(cred.credit_date)
                          ...
                          : "border-gray-300 hover:bg-[#D4C392]"
                      }`}
                    >
                      <td
